...
| `ENABLED_BACKENDS`         | No       | `docker`   | Env-configured deploy targets enabled. Supported ids: `docker`, `proxmox`. Kubernetes clusters are registered in Admin.      |
...
```env
COST_MODEL_RATES_JSON={"openai/gpt-5.4":{"input_per_1k":0.002,"output_per_1k":0.008},"claude-sonnet-4-5":{"input_per_1k":0.003,"output_per_1k":0.015},"flat-model":{"per_1k":0.004}}
```
