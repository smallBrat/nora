...
<Frame caption="GCP Console — Kubernetes Engine cluster details">
  ![GKE cluster details](/images/provisioner-backends/k8s/gke/cluster-details.svg)
</Frame>
...
<Frame caption="GCP Console — Cluster → Connect dialog (get-credentials command)">
  ![GKE connect dialog](/images/provisioner-backends/k8s/gke/connect-dialog.svg)
</Frame>
...
<Frame caption="GCP Console — Cluster → Networking (region + VPC)">
  ![GKE networking](/images/provisioner-backends/k8s/gke/networking.svg)
</Frame>
