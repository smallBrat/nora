...
GKE_K8S_NAMESPACE=nora-openclaw-agents
GKE_K8S_OPENCLAW_NAMESPACE=nora-openclaw-agents
GKE_K8S_HERMES_NAMESPACE=nora-hermes-agents
...
Open the dashboard at `http://127.0.0.1:8080`, sign in, and create an agent with **Backend = Kubernetes on GKE**.
