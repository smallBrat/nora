...
<ResponseField name="agent_id" type="string">Agent UUID.</ResponseField>
<ResponseField name="total_cost_usd" type="number">Total estimated cost in USD.</ResponseField>

<ResponseField name="breakdown" type="object">
  Cost breakdown by resource type.

  <Expandable title="properties">
    <ResponseField name="tokens_usd" type="number">Estimated cost from LLM token usage.</ResponseField>
    <ResponseField name="compute_usd" type="number">Estimated cost from compute time.</ResponseField>
  </Expandable>
</ResponseField>

<ResponseField name="period_start" type="string">Start of the billing period (ISO 8601).</ResponseField>
<ResponseField name="period_end" type="string">End of the billing period (ISO 8601).</ResponseField>
