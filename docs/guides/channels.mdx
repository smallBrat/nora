...
![Channels tab on the agent detail page — existing channels with recent message counts](/images/guides/channels/agent-channels-tab.png)
...
<Steps>
  ...
  <Step title="Click Add Channel">
    ...
    ![Add-channel form — type, name, and provider-specific credential fields](/images/guides/channels/agent-channels-add.png)
  </Step>
