...
# Prometheus pull — metrics only (0 or empty disables). Bind to an internal
# network; the scrape surface is unauthenticated by Prometheus convention.
NORA_OTEL_PROMETHEUS_PORT=9464
NORA_OTEL_PROMETHEUS_HOST=0.0.0.0
```
