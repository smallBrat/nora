...
![Workspace alert rules — active rules with last-fired and last-error fields](/images/guides/alert-rules/alerts-list.png)
...
![Create-alert-rule form — name, event pattern, and delivery channels](/images/guides/alert-rules/alerts-create.png)
