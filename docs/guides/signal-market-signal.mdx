...
<CardGroup cols={3}>
  <Card title="LinkedIn" href="/guides/integrations/linkedin" icon="linkedin" arrow>Post approved drafts.</Card>
  <Card title="Twitter / X" href="/guides/integrations/twitter" icon="twitter" arrow>Post approved drafts.</Card>
  <Card title="Instagram" href="/guides/integrations/instagram" icon="instagram" arrow>Insights (read-oriented).</Card>
  <Card title="Facebook" href="/guides/integrations/facebook" icon="facebook" arrow>Page posts.</Card>
  <Card title="Notion" href="/guides/integrations/notion" icon="book" arrow>Store the content calendar.</Card>
</CardGroup>
