...
Researches prospects, judges fit, and writes personalized first-touch messages plus short follow-up sequences in _your_ voice. **Scout drafts, you send** — nothing goes out automatically.
...
This is separate from the _outreach_ channels (email/LinkedIn/DM) you send prospects through.
